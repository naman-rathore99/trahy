...
const SAVED_PLACES = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1613395877344-13d4c2807df5?q=80&w=2000&auto=format&fit=crop",
    rating: 4.8,
    price: "$600"
  }
];
  ...
  return (
    ...
    <SafeAreaView className="flex-1 bg-gray-50 dark:bg-gray-900 px-6">
      <View className="flex-row justify-between items-center my-6">
        <Text className="text-2xl font-bold text-gray-900 dark:text-white">Saved Places</Text>
        <TouchableOpacity>
            ...
            <View className="p-4 flex-row justify-between items-center">
              <View>
                ...
                <View className="flex-row items-center mt-1">
                  ...
                  <Text className="text-gray-500 dark:text-gray-400 text-xs ml-1">{item.rating} (Review)</Text>
                </View>
              </View>
              <View>
                <Text className="text-xl font-bold text-[#FF5A1F]">{item.price}</Text>
