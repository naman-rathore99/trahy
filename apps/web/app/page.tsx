...
export default function HomePage() {
  ...
  const handleSearch = () => {
    setLoading(true);
    setOpenDate(false); // Close dropdowns on search
    setOpenGuest(false);
    setTimeout(() => {
  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-black text-gray-900 dark:text-gray-100 font-sans transition-colors pb-20 overflow-x-hidden">
      ...
      {/* --- HERO SECTION --- */}
      {/* ADDED: min-h-[600px] to give mobile enough space, and pt-24 to clear the navbar */}
      <div className="relative min-h-[75vh] md:h-[75vh] flex items-center justify-center pt-24 pb-12">
        ...
        <div className="relative z-10 w-full max-w-6xl px-4 flex flex-col items-center">
          ...
          {/* SEARCH BAR WIDGET */}
          {/* ADDED: Better padding on mobile and ensured flex-col doesn't break */}
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl w-full max-w-5xl p-3 flex flex-col md:flex-row gap-3 relative animate-in slide-in-from-bottom-10 duration-700 delay-200 border border-gray-100 dark:border-gray-800">
            {/* 1. Location Input */}
            ...
            <div
              ...
              onClick={() => {
                ...
                setOpenGuest(false); // Close other dropdown
              }}
            >
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">
                Dates
                ...
                >
                  ...
                  <style
                    ...
                    .rdrMonthAndYearPickers select {
                      color: #111827 !important; /* Dark text for month/year */
                      font-weight: bold !important;
                    }
                    .rdrDayNumber span {
                      color: #111827 !important; /* Dark text for days */
                      font-weight: 500 !important;
                    }
                    .rdrDayPassive .rdrDayNumber span {
                      color: #d1d5db !important; /* Light gray for previous/next month days */
                    }
                    .rdrDayDisabled .rdrDayNumber span {
                      color: #f3f4f6 !important;
                    }
                    .rdrWeekDay {
                      color: #6b7280 !important; /* Gray for Mon, Tue, Wed */
                    }
                    .rdrDateDisplayItem input {
                      color: #111827 !important; /* Dark text for the input boxes */
                    }
                  `,
                    }}
                  />
                  ...
                  <DateRange
                    ...
                    ranges={dateRange}
                    minDate={new Date()}
                    rangeColors={["#e11d48"]} // Rose-600 to match your theme
                    direction="vertical"
                    months={1}
                  />
                </div>
            ...
            <div
              ...
              onClick={() => {
                ...
                setOpenDate(false); // Close other dropdown
              }}
            >
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">
                Guests
              ...
              {/* GUEST DROPDOWN FIX */}
              {/* Added adaptive left-0/right-0 constraints for mobile */}
              {openGuest && (
                <div
                  ref={guestRef}
                  ...
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="w-8 h-8 rounded-full border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center justify-center disabled:opacity-30 text-gray-900 dark:text-white"
                      ...
                      <button
                        ...
                        className="w-8 h-8 rounded-full border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center justify-center text-gray-900 dark:text-white"
                      >
                        <Plus size={14} />
                      </button>
                    </div>
      ...
      <div
        ref={hotelsRef}
        className="max-w-[1400px] mx-auto px-4 md:px-8 py-16 scroll-mt-20" // added scroll-mt-20 so header doesn't hide titles on jump
      >
