...
export default function Footer() {
    ...
    // <--- 3. THE MAGIC FIX: If URL starts with "/admin", don't render anything
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 leading-relaxed text-sm">
                            Discover spiritual stays, curate your perfect pilgrimage, and travel with peace of mind. Your journey to Mathura & Vrindavan starts here.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <li><FooterLink href="/join">Become a Partner</FooterLink></li>
                            {/* <li><FooterLink href="/careers">Careers</FooterLink></li> */}
                            <li><FooterLink href="/blog">Travel Blog</FooterLink></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <li><FooterLink href="/safety">Safety Information</FooterLink></li>
                            <li><FooterLink href="/cancellation">Cancellation Options</FooterLink></li>
                            <li><FooterLink href="/report">Report a Concern</FooterLink></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:support@shubyatra.world" className="hover:text-rose-600 transition-colors">
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
    return (
        <Link href={href} className="hover:text-rose-600 dark:hover:text-rose-400 transition-colors block w-fit">
            {children}
        </Link>
    );
}